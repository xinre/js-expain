...
const astInterpreters = {
  ...
  VariableDeclarator(node) {
    console.log(node, 'VariableDeclaratorVariableDeclarator')
  ...
  ObjectExpression(node) {
    console.log(node, 'ObjectExpressionObjectExpression')
    const obj = {};
...
function evaluate(node) {
  console.log(node, 'evaluateevaluateevaluateevaluate')
  try {
